...
--  should return the name of the country, language and language percentage. Your query should 
-- arrange the result by language percentage in descending order. (1)
...
-- query should return the name of the country and the total number of cities. Your query should
-- arrange the result by the number of cities in descending order. (3)
...
-- 3. What query would you run to get all the cities in Mexico with a population of greater than
--  500,000? Your query should arrange the result by population in descending order. (1)
select cities.name, cities.population
from cities
where cities.population > 500000
order by cities.population desc;

-- 4. What query would you run to get all languages in each country with a percentage greater than 
-- 89%? Your query should arrange the result by percentage in descending order. (1)
...
select countries.name as country, cities.name as cities, cities.district, cities.population
from cities
left join countries
on cities.country_id = country_id
